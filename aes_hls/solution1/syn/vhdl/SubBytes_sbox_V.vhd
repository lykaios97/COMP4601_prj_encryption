...
architecture rtl of SubBytes_sbox_V_rom is 
...
architecture arch of SubBytes_sbox_V is
    component SubBytes_sbox_V_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    SubBytes_sbox_V_rom_U :  component SubBytes_sbox_V_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
